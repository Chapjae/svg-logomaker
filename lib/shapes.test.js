...
describe("Shapes", () => {
    describe("Triangle Instance", () => {
        it("Should make an instance of a triangle", () => {
            ...
            expect(triangle.render()).toEqual(`<svg height="200px" width="300px" xmlns="http://www.w3.org/2000/svg">
            <polygon points="150,00 00,200 300,200" fill="blue"/>
            <text x='73' y='150' fill="green" font-size="75px">SVG</text>
            </svg>`);
            })
        })   
    ...
    describe("Circle Instance", () => {
        it("Should make an instance of a circle", () => {
            ...
            expect(circle.render()).toEqual( `
                                        ...
                                        <circle cx="120" cy="100" r="100" fill='green'/>
                                        <text x='45' y='120' fill='blue' font-size="75px">SVG</text>
                                        </svg>`);
        });                           
    });
});
